...
class Smarty
{
     ...
     * @var string
     */
    var $template_dir    =  'template/templates';
     ...
     * @var string
     */
    var $compile_dir     =  'template/templates_c';
     ...
     * @var string
     */
    var $config_dir      =  'template/configs';
 ...
 */
    ...
    {
        if (is_array($tpl_var))
            foreach ($tpl_var as $thekey=>$curr_var)
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if (count($this->autoload_filters)) {
            foreach ($this->autoload_filters as $_filter_type => $_filters) {
                foreach ($_filters as $thekey=>$_filter) {
        ...
        if ($display && !$this->caching && count($this->_plugins['outputfilter']) == 0) {
            ...
            foreach ((array)$this->_plugins['outputfilter'] as $thekey=>$_output_filter) {
    ...
    function _parse_resource_name(&$params)
    {
        ...
        if ($params['resource_type'] == 'file') {
            if (!preg_match("/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/", $params['resource_name'])) {
                ...
                foreach ((array)$params['resource_base_path'] as $thekey=>$_curr_path) {
