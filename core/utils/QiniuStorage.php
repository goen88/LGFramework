 ...
 *
 */
//require_once(dirname($_SERVER['DOCUMENT_ROOT']).'/openapi/qiniu/io.php');
//require_once(dirname($_SERVER['DOCUMENT_ROOT']).'/openapi/qiniu/rs.php');
//require_once(dirname($_SERVER['DOCUMENT_ROOT']).'/openapi/qiniu/fop.php');

class QiniuStorage {
   
	var $bucket; //品牌店铺用户ID
	var $domain; //图片外链地址
	public function QiniuStorage($bucket=null,$domain=null){
	   if($bucket!=null){
	   		$this->bucket = $bucket;
	   }else{
