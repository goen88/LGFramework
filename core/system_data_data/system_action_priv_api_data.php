...
/*
          ...
          2011年09月20日
*/
class system_action_priv_api_data
{
	  //var
	  var $link;
	  var $total;
	  ...
	  //var $dd;
	  //construct
	  function system_action_priv_api_data($link)
	  {
		    $this->link = $link;
		    $this->total = 0;
		    $this->table = "system_action_priv_api";
	  ...
	  function select_a_row_by_action_path($action_path)
	  {
		    $sql_sel = "select * from ".$this->table." where action_path='".$action_path."'";
		    $dd = new database_data($this->link);
		    $row_sel = $dd->_select_one_row($sql_sel);
		    return $row_sel;
	  }
	  ...
	  function select_all_row($begin,$limit)
	  {
		    $sql_sel = "select * from ".$this->table." order by action_id desc limit ".$begin.",".$limit;
		    $dd = new database_data($this->link);
		    $arr_sel = $dd->_select_multi_row($sql_sel);
		     return $arr_sel;
	  }
