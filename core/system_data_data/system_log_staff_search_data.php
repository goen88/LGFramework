...
/*
          ...
          2011年09月23日
*/
class system_log_staff_search_data
{
	  //var
	  var $link;
	  var $total;
	  ...
	  //var $dd;
	  //construct
	  function system_log_staff_search_data($link)
	  {
		    $this->link = $link;
		    $this->total = 0;
		    $this->table = "system_log_staff_search";
	  ...
	  {
		    $sql_sel = "select * from ".$this->table." order by lid desc limit ".$begin.",".$limit;
		    $dd = new database_data($this->link);
		    $arr_sel = $dd->_select_multi_row($sql_sel);
		     return $arr_sel;
	  }
